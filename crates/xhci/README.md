...
# Modify Announce
this is a xhci lib that has been modified for our os, added some memory alignment from issue #163.since we were 64 bit os, we not gurantee 32 bit compability.
